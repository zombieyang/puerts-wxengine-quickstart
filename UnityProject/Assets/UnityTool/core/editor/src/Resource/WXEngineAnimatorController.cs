...
namespace WeChat
{
        ...
        public static Dictionary<AnimatorControllerParameterType, int> ParameterType = new Dictionary<AnimatorControllerParameterType, int>
    {
        ...
        public WXAnimatorController(Animator animator, GameObject gameObject) : base(AssetDatabase.GetAssetPath(gameObject.GetComponent<Animator>().runtimeAnimatorController.GetInstanceID()))
        {
            ...
            if (unityAssetPath == null || unityAssetPath == "")
            {
                ...
                .error(0, "animatorController文件的unity路径为空");
            }
        }
