...
namespace WeChat
{
    ...
    public class WXCapsuleCollider : WXComponent
    {
        ...
        public override string getTypeName() {
            var result = collider ? collider.GetType().ToString() : "UnityEngine.CapsuleCollider";
            return WXMonoBehaviourExportHelper.EscapeNamespace(result);
        }

        public WXCapsuleCollider(CapsuleCollider collider)
        {
        ...
        protected override JSONObject ToJSON(WXHierarchyContext context)
        {
            ...
            if (this.collider != null)
            {
                ...
                data.AddField("height", this.collider.height);
                data.AddField("direction", this.collider.direction);
            }
